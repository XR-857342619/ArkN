...
namespace Buffs
{
    public class 闪避 : Buff,IDamageModify
    {
        ...
        public override void Init()
        {
            ...
            if (Chance == -1 && AvoidType == DamageTypeEnum.general)
            {
                Array damageTypeValues = Enum.GetValues(typeof(DamageTypeEnum));
                Chance = GetValue(0);
                AvoidType = (DamageTypeEnum)damageTypeValues.GetValue((int)GetValue(1));
            }
        }

...
namespace BattleUI
{
    public partial class UI_Battle : GComponent
    {
        ...
        public GButton m_isShowDetails;
        ...
        public override void ConstructFromXML(XML xml)
        {
            ...
            m_isShowDetails = (GButton)GetChildAt(40);
            m_previewGroup = (GGroup)GetChildAt(41);
            m_endClick = (GComponent)GetChildAt(42);
            m_endPic = (GLoader)GetChildAt(43);
            m_result = (GTextField)GetChildAt(47);
            m_w1 = (GImage)GetChildAt(48);
            m_w2 = (GImage)GetChildAt(49);
            m_w3 = (GImage)GetChildAt(50);
            m_endGroup = (GGroup)GetChildAt(53);
            m_DamageInfoList = (GList)GetChildAt(54);
            m_GiveUpBack = (GGraph)GetChildAt(55);
            m_CancelGiveUp = (GComponent)GetChildAt(58);
            m_GiveUp = (UI_GiveUP)GetChildAt(59);
            m_giveupGroup = (GGroup)GetChildAt(60);

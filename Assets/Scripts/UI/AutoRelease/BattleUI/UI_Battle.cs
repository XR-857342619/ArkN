...
namespace BattleUI
{
    public partial class UI_Battle : GComponent
    {
        ...
        public override void ConstructFromXML(XML xml)
        {
            ...
            m_background = (GGraph)GetChildAt(19);
            m_bg = (GGraph)GetChildAt(20);
            m_gameSpeed = (UI_Slider2)GetChildAt(25);
            m_isInfCost = (GButton)GetChildAt(26);
            m_isInfHealth = (GButton)GetChildAt(27);
            m_isNoCD = (GButton)GetChildAt(29);
            m_isInfUnitCount = (GButton)GetChildAt(32);
            m_isNoLimitBuild = (GButton)GetChildAt(33);
            m_GiveUp2 = (UI_GiveUP)GetChildAt(35);
            m_skillPowerSpeed = (UI_Slider2)GetChildAt(36);
            m_exitSetting = (GButton)GetChildAt(37);
            m_previewGroup = (GGroup)GetChildAt(38);
            m_endClick = (GComponent)GetChildAt(39);
            m_endPic = (GLoader)GetChildAt(40);
            m_result = (GTextField)GetChildAt(44);
            m_w1 = (GImage)GetChildAt(45);
            m_w2 = (GImage)GetChildAt(46);
            m_w3 = (GImage)GetChildAt(47);
            m_endGroup = (GGroup)GetChildAt(50);
            m_DamageInfoList = (GList)GetChildAt(51);
            m_GiveUpBack = (GGraph)GetChildAt(52);
            m_CancelGiveUp = (GComponent)GetChildAt(55);
            m_GiveUp = (UI_GiveUP)GetChildAt(56);
            m_giveupGroup = (GGroup)GetChildAt(57);

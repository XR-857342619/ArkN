...
namespace BattleUI
{
    public partial class UI_Battle : GComponent
    {
        ...
        public override void ConstructFromXML(XML xml)
        {
            ...
            m_nextFrame = (GImage)GetChildAt(17);
            m_normalGroup = (GGroup)GetChildAt(19);
            ...
            m_DamageInfoList = (GList)GetChildAt(40);
            m_endClick = (GComponent)GetChildAt(41);
            m_endPic = (GLoader)GetChildAt(42);

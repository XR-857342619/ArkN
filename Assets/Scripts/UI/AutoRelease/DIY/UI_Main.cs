...
namespace DIY
{
    public partial class UI_Main : GComponent
    {
        ...
        public override void ConstructFromXML(XML xml)
        {
            ...
            m_spineMode = (GGraph)GetChildAt(38);
            m_uintGeneralAttribute = (GGroup)GetChildAt(39);
            m_unitIcon = (GLoader)GetChildAt(40);
            m_mode = (GButton)GetChildAt(41);
            m_Mode = (GGroup)GetChildAt(42);
            m_selectUnitAttribute = (GComboBox)GetChildAt(43);
            m_newUnitAttribute = (GButton)GetChildAt(44);
            m_addUnitAttribute = (GList)GetChildAt(45);
            m_delUnitAttribute = (GButton)GetChildAt(46);
            m_unitAttributeList = (GGroup)GetChildAt(47);
            m_unit = (GGroup)GetChildAt(48);
            m_skillList = (GList)GetChildAt(49);
            m_newSkill = (GButton)GetChildAt(50);
            m_delSkill = (GButton)GetChildAt(51);
            m_selectSkillAttribute = (GComboBox)GetChildAt(52);
            m_newSkillAttribute = (GButton)GetChildAt(53);
            m_addSkillAttribute = (GList)GetChildAt(54);
            m_delSkillAttribute = (GButton)GetChildAt(55);
            m_skillAttributeList = (GGroup)GetChildAt(56);
            m_skill = (GGroup)GetChildAt(57);
            m_back = (GButton)GetChildAt(58);
            m_icons = (GList)GetChildAt(60);
            m_iconList = (GGroup)GetChildAt(61);
            m_tip = (GRichTextField)GetChildAt(62);
            m_save = (GButton)GetChildAt(63);
            m_saveAsNew = (GButton)GetChildAt(64);
            m_back_2 = (GButton)GetChildAt(65);
            m_blocks = (GList)GetChildAt(67);
            m_editRange = (GGroup)GetChildAt(68);
            Init();
        }
        partial void Init();
    }

...
namespace MainUI
{
    public partial class UI_Team : GComponent
    {
        ...
        public override void ConstructFromXML(XML xml)
        {
            ...
            m_u12 = (UI_TeamUnit)GetChildAt(13);
            m_back = (GButton)GetChildAt(14);
            m_team0 = (GButton)GetChildAt(15);
            m_team1 = (GButton)GetChildAt(16);
            m_team2 = (GButton)GetChildAt(17);
            m_team3 = (GButton)GetChildAt(18);
            m_quickTeam = (GComponent)GetChildAt(19);
            m_delete = (GComponent)GetChildAt(20);
            m_right = (GButton)GetChildAt(21);
            m_left = (GButton)GetChildAt(22);
            m_support = (GComponent)GetChildAt(23);
            m_battle = (UI_GoBattle)GetChildAt(24);
            Init();
        }
        partial void Init();
    }

    ...
    partial class UI_BattleLeft
    {
        ...
        protected override void OnUpdate()
        {
            ...
            if (Unit != null)
            {
                ...
                block.GetChild("value").asTextField.text = Unit.UnitData.StopCount.ToString();
                cost.GetChild("value").asTextField.text = Unit.UnitData.Cost.ToString();
                resetTime.GetChild("value").asTextField.text = Unit.UnitData.ResetTime.ToString();
                atkGap.GetChild("value").asTextField.text = Unit.UnitData.AttackGap.ToString();
                hpRecover.GetChild("value").asTextField.text = Unit.UnitData.HpRecover.ToString();
                hatred.GetChild("value").asTextField.text = Unit.UnitData.Hatred.ToString();
                weight.GetChild("value").asTextField.text = Unit.UnitData.Weight.ToString();
                speed.GetChild("value").asTextField.text = Unit.UnitData.Speed.ToString();
